...
namespace LocacaoGaragens.Controllers
{
    public class MarcaCarroesController : ApiController
    {
        ...
        public IQueryable<MarcaCarro> GetmarcaCarros()
        {
            return db.marcaCarros;
        }
        ...
        {
            MarcaCarro marcaCarro = await db.marcaCarros.FindAsync(id);
            if (marcaCarro == null)
            {
                return NotFound();
            }
        ...
        public async Task<IHttpActionResult> DeleteMarcaCarro(int id)
        {
            ...
            db.marcaCarros.Remove(marcaCarro);
            await db.SaveChangesAsync();
        ...
        {
            return db.marcaCarros.Count(e => e.Id == id) > 0;
        }
    }
}